...
class ANTLRv4LexBasic extends Lexer_1.Lexer {
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(ANTLRv4LexBasic._ATN, this);
    }
    get vocabulary() {
        return ANTLRv4LexBasic.VOCABULARY;
    }
    get grammarFileName() { return "ANTLRv4LexBasic.g4"; }
    get ruleNames() { return ANTLRv4LexBasic.ruleNames; }
    get serializedATN() { return ANTLRv4LexBasic._serializedATN; }
    get channelNames() { return ANTLRv4LexBasic.channelNames; }
    get modeNames() { return ANTLRv4LexBasic.modeNames; }
    static get _ATN() {
        if (!ANTLRv4LexBasic.__ATN) {
            ANTLRv4LexBasic.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(ANTLRv4LexBasic._serializedATN));
        }
        return ANTLRv4LexBasic.__ATN;
    }
}
ANTLRv4LexBasic.channelNames = [
    "DEFAULT_TOKEN_CHANNEL", "HIDDEN",
];
ANTLRv4LexBasic.modeNames = [
    "DEFAULT_MODE",
];
ANTLRv4LexBasic.ruleNames = [
...
ANTLRv4LexBasic._LITERAL_NAMES = [];
ANTLRv4LexBasic._SYMBOLIC_NAMES = [];
ANTLRv4LexBasic.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(ANTLRv4LexBasic._LITERAL_NAMES, ANTLRv4LexBasic._SYMBOLIC_NAMES, []);
ANTLRv4LexBasic._serializedATN = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x02\u0130\b\x01" +
    ...
    "\xE3\xEA\x02";
exports.ANTLRv4LexBasic = ANTLRv4LexBasic;
//# sourceMappingURL=ANTLRv4LexBasic.js.map